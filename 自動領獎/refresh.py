...
import json
# 設定 API URL 和請求數據
def get_refresh(consumer_key, consumer_secret, token, token_secret, user_id, app_version):
    url = "https://tonofura-web-r.deepone-online.com/deep-one/api/myPage/refresh"
    data = {}
